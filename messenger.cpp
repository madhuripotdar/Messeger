 ...
 *  PROBLEM STATEMENT:
 *
 *  To design a system for sending and receiving messages to  registered users
...
----------------------------------------
Enter username to create : ketki_kothale

Create password: 2370
...
----------------------------------------
Enter username to create : sejal_8

Create password: 2372
...
----------------------------------------
Enter username to create : Amruta_kot

Create password: 2369
...
----------------------------------------
Enter username to create : ask_kul

Create password: 2373
...
Enter the password: 2373

Are you sure you want to delete your account?(Y/N): N
...
----------------------------------------
Enter username: sejal_8

Enter previous password: 2371

Incorrect previous password.

Enter previous password: 2372

Enter new password : 2001
...
------------------------------------------
Enter username of user to message : ketki_kothale

Enter message you want to send to @ketki_kothale :
Hii, what are u doing?

Message sent successfully to @ketki_kothale
************* HELLO @sejal_8 ! *************
0. Logout
1. Check inbox messages
2. Send a message
...
------------------------------------------
Enter username of user to message : amruta_kot

Entered username doesn't exist.
Enter username of user to message : Amruta_kot

Enter message you want to send to @Amruta_kot :
How are you?

Message sent successfully to @Amruta_kot
************* HELLO @sejal_8 ! *************
0. Logout
1. Check inbox messages
2. Send a message
...
******************************* SENT *******************************
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8     Amruta_kot          hello...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    2        sejal_8  ketki_kothale       Our mini...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    3        sejal_8     Amruta_kot       How are ...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    4        sejal_8  ketki_kothale       Hii, wha...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
********* SENT OPTIONS **********
0. Exit
1. Read a message
...
---------------------------------------------
Enter message no. to read: 1

..................................................................
************** MESSAGE 1 **************
From : sejal_8
To : Amruta_kot
When : Wed May 12 21:32:45 2021
...
---------------------------------------------
Enter message no. to read: 2

..................................................................
************** MESSAGE 2 **************
From : sejal_8
To : ketki_kothale
When : Wed May 12 21:32:17 2021
...
-------------------------------------------------------------------------------------------------
    2        sejal_8  ketki_kothale       Our mini...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    3        sejal_8  ketki_kothale       Hii, wha...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
********* SENT OPTIONS **********
0. Exit
1. Read a message
...
---------------------------------------------
Enter message no. to star/unstar: 2
Message no. 2 has been starred.
...
-------------------------------------------------------------------------------------------------
    1        sejal_8     Amruta_kot          hello...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    2        sejal_8  ketki_kothale       Our mini...        May 12      read       starred
-------------------------------------------------------------------------------------------------
    3        sejal_8  ketki_kothale       Hii, wha...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
********* SENT OPTIONS **********
...
Enter the username: ketki_kothale

**************************** MESSAGES SENT TO ketki_kothale ****************************
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8  ketki_kothale       Our mini...        May 12      read       starred
-------------------------------------------------------------------------------------------------
    2        sejal_8  ketki_kothale       Hii, wha...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
********* MESSAGE OPTIONS **********
0. Exit
1. Read a message
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8     Amruta_kot       How are ...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
********* TRASH OPTIONS **********
0. Exit
1. Delete a message permanently
...
---------------------------------------------
Enter message no. to star/unstar: 1
Message no. 1 has been unstarred.
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8  ketki_kothale       Our mini...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
    2        sejal_8  ketki_kothale       Hii, wha...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
********* INBOX OPTIONS **********
0. Exit
1. Read a message
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8  ketki_kothale       Our mini...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    2        sejal_8  ketki_kothale       Hii, wha...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
********* INBOX OPTIONS **********
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8  ketki_kothale       Hii, wha...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
********* INBOX OPTIONS **********
0. Exit
1. Read a message
...
---------------------------------------------
Enter message no. to star/unstar: 1
Message no. 1 has been starred.

******************************* INBOX *******************************
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8  ketki_kothale       Hii, wha...        May 12    unread       starred
-------------------------------------------------------------------------------------------------
********* INBOX OPTIONS **********
0. Exit
1. Read a message
...
------------------------------------------
Enter username of user to message : sejal_8

Enter message you want to send to @sejal_8 :
Working on next assignment

Message sent successfully to @sejal_8
************* HELLO @ketki_kothale ! *************
0. Logout
1. Check inbox messages
2. Send a message
...
Enter message you want to send to @Amruta_kot :
How was your working experiance with us?
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1  ketki_kothale     Amruta_kot       How was ...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    2  ketki_kothale     Amruta_kot       What's u...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    3  ketki_kothale        sejal_8       Working ...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
********* SENT OPTIONS **********
0. Exit
1. Read a message
...
Enter the username: sejal_8

**************************** MESSAGES RECEIVED FROM sejal_8 ****************************
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8  ketki_kothale       Hii, wha...        May 12    unread       starred
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1  ketki_kothale     Amruta_kot       How was ...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
    2  ketki_kothale     Amruta_kot       What's u...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
    3        sejal_8     Amruta_kot          hello...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
    4        sejal_8     Amruta_kot       How are ...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
********* INBOX OPTIONS **********
0. Exit
1. Read a message
...
---------------------------------------------
Enter message no. to star/unstar: 3
Message no. 3 has been starred.
...
-------------------------------------------------------------------------------------------------
    2  ketki_kothale     Amruta_kot       What's u...        May 12      read     unstarred
-------------------------------------------------------------------------------------------------
    3        sejal_8     Amruta_kot          hello...        May 12    unread       starred
-------------------------------------------------------------------------------------------------
    4        sejal_8     Amruta_kot       How are ...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
********* INBOX OPTIONS **********
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8     Amruta_kot          hello...        May 12    unread       starred
-------------------------------------------------------------------------------------------------
********* MESSAGE OPTIONS **********
0. Exit
1. Read a message
...
-------------------------------------------------------------------------------------------------
  No.           From             To        Message          When    Status       Starred
-------------------------------------------------------------------------------------------------
    1        sejal_8     Amruta_kot       How are ...        May 12    unread     unstarred
-------------------------------------------------------------------------------------------------
********* TRASH OPTIONS **********
0. Exit
1. Delete a message permanently
